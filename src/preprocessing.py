...
def clean_data(df: pd.DataFrame) -> pd.DataFrame:
    ...
    # В датасете имеется 3 таргета, необходимо оставить лишь интересующий нас таргет sleep_disorder_risk
...
def feature_engineering(df: pd.DataFrame) -> pd.DataFrame:
    ...
    # Добавим отношение глубокого сна ко всему сну
    # data['deep_sleep_hours'] = data['sleep_hours'] * (data['deep_sleep_percent'] / 100)
